...
import face15 from "../../assets/images/avatar.png";
...
const Header = ({ local_varaiable, ThemeChanger }: any) => {
  ...
  useEffect(() => {
    ...
    if (user && user !== "demo-token") {
      try {
        const decodedToken = jwtDecode<CustomJwtPayload>(user);
        setDecoded(decodedToken);
      } catch (error) {
        console.log("Invalid token format");
        setDecoded({ name: "Demo User", concernName: "Neem Oil Business" });
      }
    } else {
      setDecoded({ name: "Demo User", concernName: "Neem Oil Business" });
    }
            ...
            <div className="header-element">
              <div className="horizontal-logo">
                ...
                >
                  ...
                  />
                  <img src={'https://www.neemtreeorganics.com/images/logo/logo.png'} alt="logo" className="desktop-dark" />
                  <img src={'https://www.neemtreeorganics.com/images/logo/logo.png'} alt="logo" className="toggle-logo" />
...
{/* 
            <li className="header-element header-fullscreen d-none d-md-block">
